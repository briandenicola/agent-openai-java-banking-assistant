...
"BillPayment","RepeatTransaction","TransactionHistory","AccountInfo, "PortfolioInfo"
...
Don't add any comments in the output or other characters, just use json format.
    ...
    ChatHistory fewShotExamples(){
        return new ChatHistory()
                ...
                .addAssistantMessage("{\"intent\": \"None\", \"clarify_sentence\":\"I'm sorry can't help with that.I can review your account details, transactions, portfolio, and help you with your payments\"")
                .addUserMessage("can you tell my portfolio?")
                .addAssistantMessage("{\"intent\": \"PortfolioInfo\" }")
